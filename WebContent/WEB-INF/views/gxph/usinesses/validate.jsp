...
<body>
	<div class="panel panel-default">
		<ol class="breadcrumb">
			<li><a href="">客户管理</a></li>
			<li><a href="${ctx}/usinesses">商户审核</a></li>
		...
		<div class="panel-body"><input type="hidden" id="uploadtoken" value="${uploadtoken}" />
			...
			action="${ctx}/usinesses/validateform" method="post" enctype="multipart/form-data" >
				<legend>商户信息</legend>
				<input type="hidden" name="id" value="${usinesses.id}" />
				<div class="form-group">
					<label class="col-sm-2 control-label">名称</label>
						<label class="control-label">${usinesses.name}</label>
					<div class="col-sm-1">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">登录名</label>
						<label class="control-label">${usinesses.username}</label>
					<div class="col-sm-1">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">简介</label>
						<label class="control-label">${usinesses.describes}</label>
					<div class="col-sm-1">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">地址</label>
						<label class="control-label">${usinesses.address}</label>
					<div class="col-sm-1">
				...
				<div class="form-group">
					...
					<select class="control-label form-control required" name="status">
							<option
