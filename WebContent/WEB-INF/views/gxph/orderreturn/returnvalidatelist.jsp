					...
					<div class="form-group">
						<div class="input-group">
							...
							<select class="form-control" name="search_EQ_step">
								...
								<option <c:if test="${param.search_EQ_state == '0'}"> selected="selected"</c:if> value="0">未审核</option>
								<option <c:if test="${param.search_EQ_state == '1'}"> selected="selected"</c:if> value="1">退款完成</option>
							</select>
						</div>
					</div>
							...
							<c:forEach items="${orderreturnlist.content}" var="orderre">
								<tr>
									<td><%-- <a href="${ctx}/order/${order.id}/update">编辑</a>
										...
										<a href="${ctx}/orderreturn/${orderre.id}/orderreturnvalidate">审核</a>
										</td>
									...
									<td><c:if test="${orderre.state==0}"><label style="color:red;">未审核</label></c:if>
									<c:if test="${orderre.state==1}"><label style="color:red;">退款完成</label></c:if>
