			...
			<form id="inputForm" class="form-horizontal" role="form"
				...
				<div class="container">
					<div class="fileInputContainer col-sm-4 required" id="appid1">
	    				<input class="fileInput" type="file" name="file1"  onchange="openupload(this,'appid1');"/>
					...
					<div class="fileInputContainer col-sm-4" id="appid2">
	    				<input class="fileInput" type="file" name="file2" onchange="openupload(this,'appid2');"/>
					...
					<div class="fileInputContainer col-sm-4" id="appid3">
	    				<input class="fileInput" type="file" name="file3" onchange="openupload(this,'appid3');"/>
				...
				<div class="container">
					<div class="fileInputContainer col-sm-4" id="appid4">
	    				<input class="fileInput" type="file" name="file4" onchange="openupload(this,'appid4');"/>
					...
					<div class="fileInputContainer col-sm-4" id="appid5">
	    				<input class="fileInput" type="file" name="file5" onchange="openupload(this,'appid5');"/>
					...
					<div class="fileInputContainer col-sm-4" id="appid6">
	    				<input class="fileInput" type="file" name="file6" onchange="openupload(this,'appid6');"/>
