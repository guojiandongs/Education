...
public class StringX {
	...
	public static String getRealPath(ServletContext application) {
		return getRealPath(application, "/");
	}

	public static String getRealPath(ServletContext application, String uri) {
		if (application == null) {
	...
	public static String getTemplate(ServletContext application,
		...
		String tfile = leftback(jspPath, ".jsp") + "_template.html";
		return tfile;
	}

	public static String getBinding(ServletContext application,
			HttpServletRequest request) {
		if ((application == null) || (request == null)) {
		...
		String jspPath = application.getRealPath(request.getServletPath());
		String bfile = leftback(jspPath, ".jsp") + "_binding.xml";
		return bfile;
	}
