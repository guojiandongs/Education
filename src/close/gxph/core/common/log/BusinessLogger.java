 ...
 *******************************************************************************/
package close.gxph.core.common.log;
...
import close.gxph.core.common.mapper.JsonMapper;
...
public class BusinessLogger {
	...
	private Logger businessLogger = LoggerFactory
			.getLogger(BUSINESS_LOGGER_NAME);
	...
	public void log(String entity, String action, String user, Map data) {
		...
		businessLogger.info("{},{},{},{}", entity, action);
	}
}
